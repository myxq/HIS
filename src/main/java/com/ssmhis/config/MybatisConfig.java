...
// 使用通用mapper下的注解
@MapperScan(value = { "tk.mybatis.mapper.annotation","com.ssmhis.dao"}, mapperHelperRef = "mapperHelper")
public class MybatisConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory() {
        ...
        try {
            sqlSessionFactoryBean.setMapperLocations(patternResolver.getResources("classpath:dao/**/*.xml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        // mybatis 一些系统配置
