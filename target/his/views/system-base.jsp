...
<div class="page-container">
	...
	<div class="row cl">
		<div class="col-xs-1  col-sm-2">
				<button id="btn-hidden" onClick="article_save_submit();" class="btn btn-primary btn-sm radius">隐藏患者栏</button>&emsp;&emsp;
				<small id="pati-info"></small>
		</div>
		<label id="label-info" class="col-xs-6 col-sm-2">4tqr</label>
	</div>
	<br>
			...
			<div id="sbTabContent" class="tab-content">
				<div role="tabpanel" class="tab-pane fade in active" id="mediRecord"><br>
					<div class="row cl">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
						<button class="btn btn-primary"><i class="icon Hui-iconfont">&#xe60c;</i> 暂存</button>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
					...
					<label class="control-label" style="color: #2aabd2">病史内容：</label>
